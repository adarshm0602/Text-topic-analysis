...
class PDFReport(FPDF):
    def header(self):
        ...
        self.cell(200, 10, "Last Sentence Using Capitalized Method Analysis Report", ln=True, align="C")
        self.ln(10)
...
for index, filename in enumerate(file_list, 1):  
    ...
    with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
        ...
        topic = extract_description(last_sentence, stopwords)
...
pdf = PDFReport()
pdf.add_page()
pdf.add_text("Last Sentence Using Capitalized Method Analysis Report", bold=True)
...
pdf.add_text("Analysis completed. Report saved as Last_Sentence_Capitalized_Report.pdf", bold=True)
pdf_filename = "Last_Sentence_Capitalized_Report.pdf"
